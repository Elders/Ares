...
namespace Elders.Ares.Userful
{
    ...
    public class RollingPercentile
    {
       ...
       // private static readonly ILogger Logger = LoggerFactory.GetLogger(typeof(HystrixRollingPercentile));
        ...
        /// </summary>
        private readonly IProperty<int> bucketDataLength;

        /// <summary>
        /// Sets whether data should be tracked and percentiles be calculated.
        /// </summary>
        private readonly IProperty<bool> enabled;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RollingPercentile"/> class.
        /// </summary>
        ...
        public RollingPercentile(IProperty<int> timeInMilliseconds, IProperty<int> numberOfBuckets, IProperty<int> bucketDataLength, IProperty<bool> enabled)
        ...
        /// <param name="bucketDataLength">Number of values stored in each bucket.</param>
        /// <param name="enabled">Sets whether data should be tracked and percentiles be calculated.</param>
        internal RollingPercentile(ITime time, IProperty<int> timeInMilliseconds, IProperty<int> numberOfBuckets, IProperty<int> bucketDataLength, IProperty<bool> enabled)
        {
        ...
        /// <summary>
        /// Stores the values of a bucket in <see cref="RollingPercentile"/>. It's behavior is similar to a circular array,
