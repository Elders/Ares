...
namespace Elders.Ares.Userful
{
    ...
    public class RollingNumber
    {
        ...
        /// </summary>
        private readonly IProperty<int> timeInMilliseconds;

        /// <summary>
        /// The number of parts to break the time window.
        /// </summary>
        private readonly IProperty<int> numberOfBuckets;
        ...
        public RollingNumber(IProperty<int> timeInMilliseconds, IProperty<int> numberOfBuckets)
            : this(ActualTime.Instance, timeInMilliseconds, numberOfBuckets)
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RollingNumber"/> class. This constructor is used for unit testing
        ...
        internal RollingNumber(ITime time, int timeInMilliseconds, int numberOfBuckets)
            : this(time, PropertyFactory.AsProperty(timeInMilliseconds), PropertyFactory.AsProperty(numberOfBuckets))
        {
        }
        ...
        internal class Bucket
        {
            ...
            /// <summary>
            /// <see cref="LongAdder"/> instances for each <see cref="RollingNumberEvent"/>.
            /// </summary>
            private readonly LongAdder[] adderForCounterType;

            /// <summary>
            /// <see cref="LongMaxUpdater"/> instances for each <see cref="RollingNumberEvent"/>.
            /// </summary>
            ...
            public Bucket(long startTime)
            {
                ...
                this.adderForCounterType = new LongAdder[RollingNumberEventExtensions.Values.Count];
                ...
                this.updaterForCounterType = new LongMaxUpdater[RollingNumberEventExtensions.Values.Count];
                foreach (RollingNumberEvent type in RollingNumberEventExtensions.Values)
                {
            ...
            /// <summary>
            /// Gets the value for the specified <see cref="RollingNumberEvent"/> in this bucket.
        ...
        /// <summary>
        /// Cumulative counters (all time) for each <see cref="RollingNumberEvent"/> used in <see cref="RollingNumber"/>.
        /// </summary>
